...
from deaths_lib.constants import MONTHS
...
class Scraper(scraper.Scraper):
    ...
    def search(self, video_type, title, year, season=''):  # @UnusedVariable
        ...
        if video_type == VIDEO_TYPES.TVSHOW and title:
            ...
            search_title = re.sub('[/forum/7-1080p-720p-high-definition-movies/]', '', title.lower())
    ...
    def __to_slug(self, title):
        slug = title.lower()
        slug = re.sub('[/forum/7-1080p-720p-high-definition-movies -]', ' ', slug)
